 ...
 */
inline fun <T> Sequence<T>.countWithTotal(predicate: (T) -> Boolean): Pair<Int, Int> {
    var count = 0
    var totalCount = 0
    for (element in this) {
 ...
 * Overflows are not detected.
 */
fun Sequence<Int>.productLong(): Long {
    var prod = 1L
    for (element in this) prod *= element
    return prod
}
 ...
 */
inline fun <T> Sequence<T>.productOf(transform: (T) -> Double): Double {
    var prod = 1.0
 ...
 * Returns the product of all values produced by the [transform] function applied to each element in the collection.
 */
inline fun <T> Sequence<T>.productOfInt(transform: (T) -> Int): Int {
    var prod = 1
    for (element in this) prod *= transform(element)
    return prod
}
 ...
 * Returns the product of all values produced by the [transform] function applied to each element in the collection.
 */
inline fun <T> Sequence<T>.productOfLong(transform: (T) -> Long): Long {
    var prod = 1L
    for (element in this) prod *= transform(element)
    return prod
}
 ...
 * @throws ArithmeticException if the total count exceeds [Int.MAX_VALUE]
 */
inline fun <T> Sequence<T>.averageOf(transform: (T) -> Double): Double {
    var sum = 0.0
    var count = 0
    for (element in this) {
 ...
 * @throws ArithmeticException if the total count exceeds [Int.MAX_VALUE]
 */
fun <T> Sequence<T>.averageOfOrNull(transform: (T) -> Double): Double? {
    var sum = 0.0
    var count = 0
    for (element in this) {
        if (count == Int.MAX_VALUE) throw ArithmeticException("Count overflow has happened.")
 ...
 * @throws ArithmeticException if the total count exceeds [Int.MAX_VALUE]
 */
fun Sequence<Double>.empStandardDev(): Double = sqrt(this.empVariance())
 ...
 * @throws ArithmeticException if the total count exceeds [Int.MAX_VALUE]
 */
fun Sequence<Double>.empVariance(): Double {
    var sum = 0.0
    var count = 0
    for (element in this) {
        if (count == Int.MAX_VALUE) throw ArithmeticException("Count overflow has happened.")
 ...
 * @throws ArithmeticException if the total count exceeds [Int.MAX_VALUE]
 */
fun Sequence<Double>.standardDev(): Double = sqrt(this.variance())
 ...
 * @throws ArithmeticException if the total count exceeds [Int.MAX_VALUE]
 */
fun Sequence<Double>.variance(): Double {
    var sum = 0.0
    var count = 0
    for (element in this) {
        if (count == Int.MAX_VALUE) throw ArithmeticException("Count overflow has happened.")
 ...
 */
fun <T> Sequence<T>.valueCounts(): Map<T, Int> {
